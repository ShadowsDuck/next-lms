    ...
    <Link
      ...
      className={buttonVariants({
        ...
        className: cn(
          ...
          completed &&
            "bg-green-100 border-green-300 dark:bg-green-900/30 dark:border-green-700 hover:bg-green-200 dark:hover:bg-green-900/30 text-green-800 dark:text-green-200",
          isActive &&
            !completed &&
